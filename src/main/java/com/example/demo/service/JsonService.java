...
//        String thisJoinName = object.getString("objectType") + "_join";
        ...
        System.out.println(" | " + thiskey + " | START ");
        ...
        System.out.println(" Parent's Child : " + iHaveChild);
        System.out.println(" Declaring itself as Child : " + !(parentJoinName == null && parentId == null));
        ...
        if (!(parentJoinName == null && parentId == null)) {
            System.out.println(" -- -- -- ");
            System.out.println(" Declaring itself as Child with parent join name : " + parentJoinName);
